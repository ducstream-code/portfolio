<template class="flex justify-center">
  ...
  <div class="p-7 max-w-3xl">
    ...
    <p class="dark:text-black">HTML <span class="text-2xl">•</span> CSS <span class="text-2xl">•</span> JS <span class="text-2xl">•</span> PHP <span class="text-2xl">•</span> SQL <span class="text-2xl">•</span>
      ...
      <h1 class="_fullname font-semibold text-white text-xl border-b-4 border-gray-600 w-32 mb-2 mt-5 dark:text-black ">Sur internet</h1>
     <a href="https://github.com/ducstream-code" class="flex place-items-center text-teal-500 font-semibold ml-6"><span class="flex place-items-center mr-2 dark:text-teal-900"><ion-icon name="logo-github"></ion-icon></span>@ducsteam-code</a>
     <a href="https://www.linkedin.com/in/aurelien-krief/" class="flex place-items-center text-teal-500 font-semibold ml-6"><span class="flex place-items-center mr-2 dark:text-teal-900"><ion-icon name="logo-linkedin"></ion-icon></span>Aurélien Krief</a>
     <a href="https://www.instagram.com/aurelienkrf/" class="flex place-items-center text-teal-500 font-semibold ml-6"><span class="flex place-items-center mr-2 dark:text-teal-900"><ion-icon name="logo-instagram"></ion-icon></span>@aurelienkrf</a>
